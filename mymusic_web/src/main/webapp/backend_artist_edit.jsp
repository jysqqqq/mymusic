        ...
        <div class="mainBar">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body" style="height: 700px;">
                    <form id="AlbumForm" action="/backend/artist/artist-edit" method="post" enctype="multipart/form-data">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="InputName" name="name" placeholder="请输入艺人名称" value="${ARTIST.name}" oninput="inputName_input()" onchange="inputAlias_change()"  autocomplete="off" >
                            </div>
                            <div id="AliasBox" class="form-group has-feedback">
                                ...
                                <input type="text" class="form-control" id="InputAlias" name="alias"
                                       placeholder="请输入艺人别名" value="${ARTIST.alias}" onchange="inputAlias_change()" autocomplete="off" >
                            </div>
                            <div class="form-group">
                                <label for="InputLanguage">艺人语种</label>
                                <input type="text" class="form-control" id="InputLanguage" name="language"
                                       placeholder="请输入艺人语种" value="${ARTIST.language}">
                            </div>
                            <div class="form-group">
                                <label for="InputInfo">简介</label>
                                <textarea id="InputInfo" wrap="hard" name="info" class="form-control" rows="3"
                                          placeholder="请输入艺人简介" value="${ARTIST.info}"></textarea>
                            </div>
                            <input type="hidden" name="id" value="${ARTIST.id}">
                            <input type="hidden" name="avatar" value="${ARTIST.avatar}">
    ...
    function inputAlias_change() {
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                }else if (result.alias == "${ARTIST.alias}") {
                    $("#AliasBox").removeClass("has-error").addClass("has-success");
                    $("#AliasLabel").html("艺人别名");
                    $("#submitBtn").removeAttr("disabled");
                }else {

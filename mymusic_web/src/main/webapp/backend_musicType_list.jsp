        ...
        <div class="mainBar">
            ...
            <div class="panel panel-info" style="margin-bottom: 0;">
                ...
                <div class="panel-body" style="height: 200px;">
                    <form action="/backend/musicType/query" method="post">
                ...
                <div class="panel-body" style="height: 500px;">
                    <table class="table table-striped table-hover">
                        ...
                        <c:if test="${not empty LIST}">
                            <c:forEach items="${LIST}" var="MUSIC_TYPE">
                                <tr>
                                    <td style="vertical-align: middle;">${MUSIC_TYPE.name}</td>
                                    <td style="vertical-align: middle;">${MUSIC_TYPE.enName}</td>
                                    <td style="vertical-align: middle;">
                                        ...
                                        <a href="/backend/musicType/edit/${MUSIC_TYPE.id}"

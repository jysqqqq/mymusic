        ...
        <div class="mainBar">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body" style="height: 550px;">
                    <form id="AlbumForm" action="/backend/album/album-add" method="post" enctype="multipart/form-data">
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div id="authorBox" class="form-group has-feedback">
                                ...
                                <input type="text" class="form-control" id="InputAuthor" name="alias"
                                       placeholder="请输入作者名" list="aliasList" onchange="inputAuthor_change()" oninput="inputAuthor_input()" autocomplete="off" >
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="InputInfo" name="info" class="form-control" rows="3"
                                          placeholder="请输入专辑简介"></textarea>
                            </div>

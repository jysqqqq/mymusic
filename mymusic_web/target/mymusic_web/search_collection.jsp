        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <c:if test="${not pageInfo.isFirstPage}">
                    <li>
                        <a href="/search/collection/${name}/${pageInfo.prePage}" aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                        </a>
                    </li>
                </c:if>
                <c:forEach items="${pageInfo.navigatepageNums}" var="index">
                    ...
                    <c:if test="${index ne pageInfo.pageNum}">
                        <li>
                            <a href="/search/collection/${name}/${index}">${index}</a>
                        </li>
                    </c:if>
                </c:forEach>
                ...
                <c:if test="${not pageInfo.isLastPage}">
                    <li>
                        <a href="/search/collection/${name}/${pageInfo.nextPage}" aria-label="Next">
                            <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                </c:if>

...
<div class="container" style="padding: 0px;background: white;">
    <div class="post" style="min-height: 700px;">
        <form   id="CollectionForm" action="/collection/collection-edit" method="post" enctype="multipart/form-data">
            <div id="mainRow" class="row clearfix">
                <div class="col-lg-3">
                    <div class="albumCoverBox">
                        <img id="collectionCover" src="/${COLLECTION.cover}" class="img-rounded img-thumbnail musicCover center-block"/>
                ...
                <div class="col-lg-9">
                    <div class="musicDetailBox">
                        ...
                        <div class="collectionInputBox">
                            <input type="hidden" value="${COLLECTION.userId}" name="userId">
                            <input type="hidden" value="${COLLECTION.pubDate}" name="pubDate">
                            <input type="hidden" value="${COLLECTION.id}" name="id">
                            <input type="hidden" value="${COLLECTION.cover}" name="cover">
                            <div class="form-group">
                                <label for="InputName">标题</label>
                                <input type="text" name="name" class="form-control" value="${COLLECTION.name}" id="InputName" placeholder="请输入标题" required>
                            </div>
                            <div class="form-group" style="width: 50%">
                                <label for="InputType">标签</label>
                                <input type="text" name="type" class="form-control" id="InputType" value="${COLLECTION.type}" placeholder="请输入歌单类型 用 ; 隔开">
                            </div>
                            <div class="form-group">
                                <label for="InptInfo">简介</label>
                                <textarea name="info"  class="form-control" rows="5"  id="InptInfo" placeholder="请输入简介">${COLLECTION.info}</textarea>
                            </div>
